  ...
  public: {
    Tables: {
      ...
      admin_competition_access: {
        ...
        Relationships: [
          {
            foreignKeyName: "admin_competition_access_competition_id_fkey"
      ...
      voice_room_reactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "voice_room_reactions_room_id_fkey"
            columns: ["room_id"]
            isOneToOne: false
            referencedRelation: "voice_rooms"
            referencedColumns: ["id"]
